                ...
                match error.kind {
                    ErrorKind::Functional => {
                        ...
                        match error.code.as_str() {
                            "mandatory_field_missing" => MovePlayerResponseCodesAndBody::InvalidInput(error_payload),
                            "id_must_be_positive_int" => MovePlayerResponseCodesAndBody::InvalidInput(error_payload),
                    ...
                    ErrorKind::Technical => {
                        // For technical errors, log the error and return a generic server error response
